...
const CoreValue = () => {
  return (
    <div className=" mt-4 container-fluid ourCoreValueAnimate mb-2 px-2 px-md-3 px-lg-5">
      <div className="row SenideaEnableAllDiv d-flex justify-content-between mx-auto">
        <div className=" col-lg-6">
          <ul className="mt-2">
            ...
            <li className="mt-3">
              <span className="fw-bolder text-dark">Community-Driven -</span>
              We work hand-in-hand with local communities to ensure every action
              we take is meaningful and sustainable.
            </li>
            <li className="mt-2">
              <span className="fw-bolder text-dark">Hope -</span> We are driven
              by the belief that positive change is always possible, and we work
              every day to be a part of that hope.
            </li>
          </ul>
        </div>
